...
function showPasswordForm(email) {
    ...
    passwordForm.addEventListener('submit', function(event) {
        ...
        // Verificar se o usuário já está no localStorage
        if (!userInfo) {
            // Se não existir, criar um novo objeto de usuário
        ...
        // Salvar o objeto do usuário no localStorage
        ...
        // Remover o formulário depois de exibir a mensagem de sucesso
        passwordForm.remove();
    });
}
